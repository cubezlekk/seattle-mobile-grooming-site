  ...
  return (
    <div className="min-h-screen bg-paper text-ink px-6 py-24 max-w-3xl mx-auto">
      ...
      <p className="font-body text-muted leading-relaxed mb-4">
        Seattle Mobile Grooming Co. collects only the information you submit through our
        contact form (your name, email, phone, address, and pet details) in order to schedule
        your mobile appointment. We do not sell or share your information with third parties.
      </p>
